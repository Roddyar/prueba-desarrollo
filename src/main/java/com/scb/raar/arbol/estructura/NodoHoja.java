...
public class NodoHoja<Clave extends Comparable<Clave>> extends Nodo {
    ...
    public NodoHoja(Elemento elem1) {
    ...
    public int addElemento(Clave clave, int posicion, ArbolRaiz archivo) throws ArbolException {
        if (this.isHoja()) {
            if (this.isEmpty()) {
                ...
                NodoInterno<Clave> nodoInterno = new NodoInterno<>((Clave) ordenado[1].getClave());
    ...
    public void eliminar(Clave clave, ArbolRaiz archivo) throws ArbolException {
        ...
        if (numElementos == 2) {
            if (isIgual(clave, (Clave) this.getElementos()[1].getClave())) {
                ...
                if (ramaPerteneceNodo == 0)
                    parent.cambiarClave(clave, (Clave) this.getElementos()[0].getClave(), archivo);
                else {
            ...
            if (parent.getNumElementos() == 2) {
                ...
                if (ramaPerteneceNodo == 0) {
                    ...
                    if (hermanoDer.getNumElementos() == 2) this.robarDerecha(0, archivo, parent, hermanoDer);
                        ...
                        parent.setRamaIzq(parent.getRamaCen());
                        parent.cambiarClave(clave, (Clave) hermanoDer.getElementos()[0].getClave(), archivo);
                        this.borradoComun(parent, archivo, hermanoDer);
                    }
                } else if (ramaPerteneceNodo == 1) {
                    NodoHoja hermanoIzq = (NodoHoja) archivo.leer(prev);
                    if (hermanoIzq.getNumElementos() == 2) this.robarIzquierda(1, archivo, parent, hermanoIzq);
                        ...
                        this.cambiarListaLigada(archivo);
                        this.borradoComun(parent, archivo, hermanoIzq);
                    }
                }
            }
        }
    ...
    public void borradoComun(NodoInterno parent, ArbolRaiz file, NodoHoja brother) throws ArbolException {
        parent.setRamaCen(0);
        parent.setClave(0, null);
        parent.setNumElementos(0);
        file.eliminar(this.getPosicion());
        file.Modificar(parent.getPosicion(), parent);
        if (parent.getPadre() == 0 && parent.getNumElementos() == 0) {
            file.setRaiz(brother.getPosicion());
            brother.setPadre(0);
            brother.setNext(0);
            brother.setPrev(0);
            file.Modificar(brother.getPosicion(), brother);
        } else {
            parent.eliminar(file);
        }
    }

    public void cambiarListaLigada(ArbolRaiz archivo) throws ArbolException {
    ...
    public void robarDerecha(Integer tipoRama, ArbolRaiz archivo, NodoInterno parent, NodoHoja HermanoDer) throws ArbolException {
    ...
    public void robarIzquierda(Integer tipoRama, ArbolRaiz archivo, NodoInterno parent, NodoHoja HermanoIzq) throws ArbolException {
