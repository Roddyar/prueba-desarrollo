...
public class NodoInterno<Clave extends Comparable<Clave>> extends Nodo {
    ...
    public void insertar(int posNuevoNodo, ArbolRaiz archivo) throws ArbolException {

        NodoInterno nuevoNodo = (NodoInterno) archivo.leer(posNuevoNodo);

        if (isMenorIgual(nuevoNodo.getClave(0), (Clave) this.clave[0])) {
    ...
    public int dividiNodoInterno(int posNuevoNodo, ArbolRaiz archivo) throws ArbolException {
        ...
        if (isMenorIgual(nodoInternoResultanteDivisionAnterior.getClave(0), (Clave) this.clave[0])) {
        ...
        else if (isMayor(nodoInternoResultanteDivisionAnterior.getClave(0), (Clave) this.clave[1])) {
    ...
    public void eliminar(ArbolRaiz archivo) throws ArbolException {
        ...
        if (parent.getNumElementos() == 2) {
            if (ramaActual == 0) {
                ...
                if (hermanoIzq.getNumElementos() == 2) this.robarIzquierda(ramaActual, archivo, parent, hermanoIzq);
                    ...
                    this.FusionarDerecha(archivo, parent, hermanoIzq);
                }
    ...
    public void robarDerecha(Integer ramaActual, ArbolRaiz archivo, NodoInterno parent, NodoInterno hermanoDer) throws ArbolException {
    ...
    public void robarIzquierda(Integer ramaActual, ArbolRaiz archivo, NodoInterno parent, NodoInterno hermanoIzq) throws ArbolException {
    ...
    public void FusionarIzquierda(Integer ramaActual, ArbolRaiz archivo, NodoInterno parent, NodoInterno hermano) throws ArbolException {
    ...
    public void FusionarDerecha(ArbolRaiz archivo, NodoInterno parent, NodoInterno hermano) throws ArbolException {
    ...
    public void fusionComun(ArbolRaiz file) throws ArbolException {

        Nodo nuevaRama1 = (Nodo) file.leer(this.getRamaIzq());
        Nodo nuevaRama2 = (Nodo) file.leer(this.getRamaCen());
        nuevaRama1.setPadre(this.getPosicion());
        nuevaRama2.setPadre(this.getPosicion());
        file.Modificar(nuevaRama1.getPosicion(), nuevaRama1);
        file.Modificar(nuevaRama2.getPosicion(), nuevaRama2);
